...
public class RgbToYCrCb extends UnaryFunction {
	...
	/**
	 * Evaluates this expression at the given x,y point by evaluating from RGB to YCrCb of
	 * the function's parameter.
	 * 
	 * @return the color from evaluating from RGB to YCrCb of the expression's parameter
	 */
	@Override
